...
bool PhoenixAudioManager::loadMultisampleConfig(const char *dir){
  Serial.printf("V1.0.3 MS CFG begin dir=%s\n",dir?dir:"?");
  ...
  File f=SD.open(p,FILE_READ);if(!f){Serial.println("V1.0.3 MS CFG absent");return false;}
