# Building Project Phoenix v1.1.0
...
`firmware/Phoenix_v1_1_0_FINAL_CLEAN/Phoenix_v1_1_0_FINAL_CLEAN.ino`
...
This repository packages the hardware-confirmed v1.1.0 source. No precompiled binary is supplied. Compile and flash with the reference Arduino environment or an equivalent compatible setup.
