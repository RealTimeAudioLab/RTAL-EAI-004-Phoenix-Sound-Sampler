...
**4 Sample Slots · 12 Voices · Multisampling · Realtime Sequencer · Sample Editor · Stereo Reverb · MIDI · USB · Phoenix Librarian**
...
[![Release](https://img.shields.io/badge/Release-v1.1.0_FINAL-success?style=for-the-badge)](#release-status)
...
<p align="center">
  <img src="images/Phoenix_Draw_Waveform.gif"
       alt="Phoenix waveform editing demonstration"
       width="800">
</p>
...
<p align="center">
  <img src="images/Phoenix_Sample_Editor.gif"
       alt="Phoenix sample editor demonstration"
       width="800">
</p>
...
├── SESSION_B.BIN
├── LASTBANK.CFG
├── INIT_SOUND.CFG        (optional NEW BANK template)
├── WAV/
├── EXPORT/
│
└── BANKS/
...
docs/
├── Phoenix_v1_0_0_Handbuch_DE.pdf
